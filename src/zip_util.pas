...
type
  // Percent: 0..100; bytes-extracted across the whole archive
...
// callback fires per-file based on byte progress; nil to skip reporting.
...
type
  // bridges Zipper's progress signature into our simpler callback
...
begin
  ...
  // LIFO: UnZip frees first, then Bridge; UnZip drops OnProgressEx before destruction
