...
type
  // Percent: 0..100; reports byte progress across the whole archive
  TZipProgress = procedure(Percent: Integer; const Status: string) of object;

// extract every entry of ZipPath into DestDir; pass nil to skip progress
...
begin
  ...
  // LIFO: UnZip frees first, then Bridge; UnZip drops handler before destruction
